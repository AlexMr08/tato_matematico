...
/// **Nombre de la Clase: `AjustesSonidosProfe**
///
/// **Descripción:** Clase usada para los ajustes de sonido en el profesor
///
/// ---
...
/// * **Último cambio:** Retoques finales

class AjustesSonidosProfe extends StatefulWidget {
  const AjustesSonidosProfe({super.key});

  @override
  _AjustesSonidosProfeState createState() => _AjustesSonidosProfeState();
}

class _AjustesSonidosProfeState extends State<AjustesSonidosProfe> {
  ...
  void _initializeSettings() {
    ...
    _sonidoEleccion = (_alumno.sonidoEleccion?.isNotEmpty ?? false)
        ? _alumno.sonidoEleccion!
        : 'ninguno';
    _sonidoVictoria =
        _alumno.sonidoAciertoActivado && _alumno.sonidoAcierto.isNotEmpty
        ? _alumno.sonidoAcierto
        : 'ninguno';
    _sonidoFallo = _alumno.sonidoFalloActivado && _alumno.sonidoFallo.isNotEmpty
        ? _alumno.sonidoFallo
        : 'ninguno';
          ...
          children: [
            Row(
              ...
              children: [
                Expanded(
                  flex: 1,
                  child: _buildTtsColumn(context, textColor, selectionColor),
                ),
                const SizedBox(width: 20),
                Expanded(
                  flex: 2,
                  child: _buildSoundsColumn(context, textColor, selectionColor),
                ),
              ],
            ),
          ],
