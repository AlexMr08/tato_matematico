...
/// **Nombre de la Clase: `Juego1Screen**
///
/// **Descripción:** Clase usada para la vista del juego 1 en el alumno
///
/// ---
...
class _Juego1ScreenState extends State<Juego1Screen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ScaffoldAlumno(
      ...
      onAjustes: () {
        Navigator.pushNamed(context, '/juego1_ajustes').then((_) {
          // Al volver de ajustes, reiniciamos la ronda para aplicar cambios de rango/imagen
